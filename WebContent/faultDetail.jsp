...
<%
	String id=(String)request.getSession().getAttribute("issuedetailid");
	Fault fault=(Fault)request.getAttribute("faultinfo");
%>
<%--=id --%>
<form  action="FaultEditServlet" method="post" target="_top">
	 <table width="100%" height="100%">	
	 	<tr>
	 		<td valign="top" width="15%"><b><font color="#AE0000">* </font>Issue Id:</b></td>
	 		<td valign="top" width="90%"><input type="text" value='${faultinfo["id"]}' name="issueid" size="10"></td>
	 	</tr>
	 	<tr>
	 		<td valign="top" width="15%"><b>&nbsp;&nbsp;Issue Type:</b></td>
	 		<td valign="top" width="90%"><input type="text" value='${faultinfo["type"]}' name="issuetype" size="10"></td>
	 	</tr>
	 	<tr>
